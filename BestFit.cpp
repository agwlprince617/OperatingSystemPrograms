...
void bestFit(int block_size[],int process_size[],int total_blocks,int total_process){
...
int main(){
    int block_size[]={100, 500, 200, 300, 400};
    int process_size[]={112, 518, 110, 526};
    int total_blocks=sizeof(block_size)/sizeof(block_size[0]);
    int total_process=sizeof(process_size)/sizeof(process_size[0]);
    bestFit(block_size,process_size,total_blocks,total_process);
}